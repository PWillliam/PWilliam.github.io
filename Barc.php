...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="Barc.css">
...
<nav>
        ...
        <div> 
            ...
            <box-icon id='menu' name="menu" color="lightseagreen" size="30px"></box-icon>
            <box-icon name="x" type="icon" color="lightseagreen" size='30px'></box-icon>
        </div>
    </nav>
    <script>
        $('#menu').click(function() {
